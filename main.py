    ...
    if request.method == "POST":
        ...
        try:
            ...
            def stringToEdgeImage(base64_string):
                ...
                img_blur = cv2.GaussianBlur(np.array(img_gray), (3, 3), 0)
            ...
            # scaler.fit(x_train)
            #
            # # Transform your input data using the fitted scaler
            # input_data = np.array([[var, sk, kur, ent]])
